...
public final class LayoutBinding implements ViewBinding {
  ...
  private LayoutBinding(@NonNull LinearLayout rootView, @NonNull Button login,
      @NonNull ImageView logo, @NonNull EditText password, @NonNull TextView register,
  ...
  public static LayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutBinding((LinearLayout) rootView, login, logo, password, register, username);
    }
