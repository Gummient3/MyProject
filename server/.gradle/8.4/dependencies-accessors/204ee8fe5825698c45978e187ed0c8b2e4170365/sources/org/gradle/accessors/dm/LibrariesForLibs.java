...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KtorNetworkLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorNetworkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for tls (io.ktor:ktor-network-tls-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getTls() {
                return create("ktor.network.tls");
        }
    ...
    public static class KtorSerializationLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorSerializationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for jackson (io.ktor:ktor-serialization-jackson-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class KtorServerLibraryAccessors extends SubDependencyFactory {
        ...
        private final KtorServerDoubleLibraryAccessors laccForKtorServerDoubleLibraryAccessors = new KtorServerDoubleLibraryAccessors(owner);
        ...
        public KtorServerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for websockets (io.ktor:ktor-server-websockets-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of libraries at ktor.server.double
         */
        public KtorServerDoubleLibraryAccessors getDouble() {
            return laccForKtorServerDoubleLibraryAccessors;
        }
    ...
    public static class KtorServerAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KtorServerAuthLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for ldap (io.ktor:ktor-server-auth-ldap-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLdap() {
                return create("ktor.server.auth.ldap");
        }
    ...
    public static class KtorServerAutoHeadLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorServerAutoHeadLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for response (io.ktor:ktor-server-auto-head-response-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class KtorServerDoubleLibraryAccessors extends SubDependencyFactory {

        public KtorServerDoubleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for receive (io.ktor:ktor-server-double-receive-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class ExposedVersionAccessors extends VersionFactory  {
        ...
        public ExposedVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: exposed.version (0.56.0)
